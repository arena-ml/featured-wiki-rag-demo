...
if ! python3 llm1-gen-summaries-zeroshot.py; then
    log_error "llm1-gen-summaries-zeroshot failed to execute. Please check the script and inputs."
fi
...
mv llm1-summaries-using-zeroshot.json  "${OUTPUT_DIR}"/llm1-summaries-using-zeroshot/
